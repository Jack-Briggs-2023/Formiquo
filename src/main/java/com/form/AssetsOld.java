...
//     static Preferences appPreferences = Preferences.userNodeForPackage(AssetsOld.class); // add saving preferences to class
...
//         }
//         Font defaultFont = Font.loadFont(AssetsOld.class.getResourceAsStream(fontPath), size); // Load custom font from resources
